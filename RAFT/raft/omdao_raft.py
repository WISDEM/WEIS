...
class RAFT_OMDAO(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('properties_roll inertia at sysCG', val=np.zeros(ndim), units='kg*m**2', desc='Roll inertia about the total system CG')
        self.add_output('properties_pitch inertia at sysCG', val=np.zeros(ndim), units='kg*m**2', desc='Pitch inertia about the total system CG')
        self.add_output('properties_yaw inertia at sysCG', val=np.zeros(ndim), units='kg*m**2', desc='Yaw inertia about the total system CG')
