These examples run an OpenFAST model that has not been generated by WISDEM; it can be used to tune and optimize the ROSCO controller and run OpenFAST DLC cases.
