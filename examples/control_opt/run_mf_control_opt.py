...
from weis.aeroelasticse.LinearFAST import LinearFAST, gen_linear_model
...
if __name__ == '__main__':
    ...
    wind_speeds = np.arange(10,20,2).tolist()
    gen_linear_model(wind_speeds,dofs=['GenDOF','TwFADOF1','PtfmPDOF'])
