...
fname_modeling_options = os.path.join(run_dir, "..", "04_frequency_domain_analysis_design", "umaine_semi_raft_opt_modeling.yaml")
fname_analysis_options = os.path.join(run_dir, "raft_doe_analysis.yaml")
