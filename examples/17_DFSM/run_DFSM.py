...
if __name__ == '__main__':
    ...
    # datapath
    region = 'BR'
    datapath = mydir + os.sep + 'outputs' + os.sep + 'MHK_BR_10' + os.sep + 'openfast_runs/rank_0'
    ...
    reqd_outputs = ['YawBrTAxp', 'NcIMURAys', 'GenPwr'] #['TwrBsFxt', 'GenPwr'] #['YawBrTAxp', 'NcIMURAys', 'GenPwr'] #,'TwrBsMyt'
    ...
    file_name = None#'DFSM_MHK_TR_nowave.mat'
    ...
    # plot data
    plot_inputs(sim_detail,4,'separate',save_flag = False)
    ...
    for isample in n_samples:
        ...
        # plot dfsm
        plot_dfsm_results(U_list,X_list,dx_list,Y_list,simulation_flag,outputs_flag,save_flag = False)
