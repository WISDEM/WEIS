...
def RK4(x0, dt, tspan, DFSM, param, extrap = False):
    ...
    for h in range(1,n):
        ...
        if not(DFSM.FA_Acc_ind_s == None):
            turbine_state['FA_Acc'] = X[h,DFSM.FA_Acc_ind_s]/100
    ...
    return T,X,U, T_extrap, U_extrap 
...
if __name__ == '__main__':
    ...
    for idx,ind in enumerate(test_inds):
        ...
        if True: 
            ...
            t1 = timer.time()
            T_dfsm, X_dfsm, U_dfsm,T_extrap, U_extrap = RK4(x0, dt, tspan, dfsm_model, param, extrap = True)
            t2 = timer.time()
            ...
            #----------------------------------------------------------------------
            save_flag = True;plot_path = 'plots_ROSCO_TR_nw_new'
