...
if __name__ == '__main__':
    ...
    lib_name = os.path.join('/home/athulsun/anaconda3/envs/weis-env/lib','libdiscon.so') #<----Update to the location of the ROSCO library 
        ...
        if True: 
            ...
            for iy,output in enumerate(output_names):
                ...
                if save_flag:
                    ...
                    fig.savefig(plot_path +os.sep+ output +str(idx) + '_comp.pdf')
