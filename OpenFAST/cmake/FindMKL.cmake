...
find_library(MKL_DEF_LIB
  NAMES mkl_def libmkl_def mkl_def_dll
  PATHS ${MKLSEARCHPATHS}
  NO_DEFAULT_PATH)

if (MKL_IFACE_LIB AND MKL_SEQ_LIB AND MKL_CORE_LIB AND MKL_DEF_LIB)
  set(MKL_LIBRARIES ${MKL_IFACE_LIB} ${MKL_SEQ_LIB} ${MKL_CORE_LIB} ${MKL_DEF_LIB})
else()
  set(MKL_LIBRARIES "")
...
find_package_handle_standard_args(MKL DEFAULT_MSG
  MKL_LIBRARIES MKL_IFACE_LIB MKL_SEQ_LIB MKL_CORE_LIB MKL_DEF_LIB) # MKL_INCLUDE_DIRS)
mark_as_advanced(
  MKL_INCLUDE_DIRS MKL_LIBRARIES MKL_IFACE_LIB MKL_SEQ_LIB MKL_CORE_LIB MKL_DEF_LIB)
