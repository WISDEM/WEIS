...
class InputWriter_OpenFAST(object):
    ...
    def write_AeroDyn15(self):
        ...
        f.write('{:<22} {:<11} {:}'.format(', '.join(self.fst_vt['AeroDyn15']['NacCenB']), 'NacCenB', '- Position of nacelle center of buoyancy from yaw bearing in nacelle coordinates (m)\n'))
        # f.write('{:<22},{:<22},{:<22}, {:<11} {:}'.format(self.fst_vt['AeroDyn15']['NacCenB'], 'NacCenB', '- Position of nacelle center of buoyancy from yaw bearing in nacelle coordinates (m)\n'))
