...
class InputWriter_OpenFAST(InputWriter_Common):
    ...
    def write_MAP(self):
        ...
        for i in range(self.fst_vt['MoorDyn']['NTypes']):
            ...
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['CB']))
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['CIntDamp']))
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['Ca']))
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['Cdn']))
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['Cdt']))
        f.write(" ".join(ln) + '\n')
        ...
        for i, type in enumerate(self.fst_vt['MoorDyn']['Type']):
            ln =[]
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['Node'][i]))
            ...
            ln.append('{:<11}'.format(self.fst_vt['MoorDyn']['B'][i]))
        ...
        for i in range(self.fst_vt['MoorDyn']['NLines']):
            ...
            # ln.append('{:<11}'.format(" ".join(self.fst_vt['MoorDyn']['Flags'])))
            f.write(" ".join(ln) + '\n')
        ln =[]
        f.write('---------------------- SOLVER OPTIONS-----------------------------------------\n')
        f.write('{:<11s}'.format('Option'+'\n'))
        f.write('{:<11s}'.format('(-)')+'\n')
        f.write("\n".join(self.fst_vt['MoorDyn']['Option']).strip() + '\n')
