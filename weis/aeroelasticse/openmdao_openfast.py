    ...
    def setup_cases(self,modeling_options,inputs,discrete_inputs,fst_vt):
        ...
        if self.options['modeling_options']['OpenFAST']['from_openfast']:
            ...
            if os.path.isfile(reg_traj):
                ...
                logger.warning("A yaml file with rotor speed, pitch, and Ct is required in modeling options->OpenFAST->regulation_trajectory. This file does not exist. Check WEIS example 02 for a template file")
