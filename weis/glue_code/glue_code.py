...
class WindPark(om.Group):
    ...
    def setup(self):
        ...
        if modeling_options['Level3']['flag']:
            ...
            self.connect('towerse.transition_piece_mass',   'aeroelastic.transition_piece_mass')
            self.connect('towerse.transition_piece_I',      'aeroelastic.transition_piece_I')
            self.connect('towerse.gravity_foundation_mass', 'aeroelastic.gravity_foundation_mass')
            self.connect('towerse.gravity_foundation_I',    'aeroelastic.gravity_foundation_I')
