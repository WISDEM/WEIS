...
class WindPark(om.Group):
    ...
    def setup(self):
        ...
        if modeling_options['Level3']['flag'] or modeling_options['Level2']['flag']:
            ...
            #self.connect('rotorse.re.blade_maxc_wohlerexp', 'aeroelastic.blade_maxc_wohlerexp')
            #self.connect('rotorse.re.blade_maxc_wohlerA', 'aeroelastic.blade_maxc_wohlerA')
            #self.connect('rotorse.re.blade_maxc_ultstress', 'aeroelastic.blade_maxc_ultstress')
