    ...
    def setup(self):
        ...
        if modeling_options['OpenFAST']['flag'] or modeling_options['OpenFAST_Linear']['flag']:
            ...
            if not modeling_options['OpenFAST']['from_openfast']:
                ...
                self.connect('rotorse.EA', 'aeroelastic.blade:EA')
                self.connect('rotorse.EIxx', 'aeroelastic.blade:EIxx')
                self.connect('rotorse.EIyy', 'aeroelastic.blade:EIyy')
                self.connect('rotorse.EIxy', 'aeroelastic.blade:EIxy')
                self.connect('rotorse.GJ', 'aeroelastic.blade:GJ')
                self.connect('rotorse.re.precomp.EA_EIxx', 'aeroelastic.blade:EA_EIxx')
                self.connect('rotorse.re.precomp.EA_EIyy', 'aeroelastic.blade:EA_EIyy')
                self.connect('rotorse.re.precomp.EIxx_GJ', 'aeroelastic.blade:EIxx_GJ')
                self.connect('rotorse.re.precomp.EIyy_GJ', 'aeroelastic.blade:EIyy_GJ')
                self.connect('rotorse.re.precomp.EA_GJ', 'aeroelastic.blade:EA_GJ')
                self.connect('rotorse.rhoA', 'aeroelastic.blade:rhoA')
                self.connect('rotorse.rhoJ', 'aeroelastic.blade:rhoJ')
                self.connect('rotorse.re.Tw_iner', 'aeroelastic.blade:Tw_iner')
                self.connect('rotorse.re.x_cg', 'aeroelastic.blade:x_cg')
                self.connect('rotorse.re.y_cg', 'aeroelastic.blade:y_cg')
                self.connect('rotorse.re.x_tc', 'aeroelastic.blade:x_tc')
                self.connect('rotorse.re.y_tc', 'aeroelastic.blade:y_tc')
                self.connect('rotorse.re.x_sc', 'aeroelastic.blade:x_sc')
                self.connect('rotorse.re.y_sc', 'aeroelastic.blade:y_sc')
                self.connect('rotorse.A', 'aeroelastic.blade:A')
                self.connect('rotorse.re.precomp.edge_iner', 'aeroelastic.blade:edge_iner')
                self.connect('rotorse.re.precomp.flap_iner', 'aeroelastic.blade:flap_iner')
