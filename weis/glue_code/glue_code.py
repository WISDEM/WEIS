    ...
    def setup(self):
        ...
        if modeling_options['Level1']['flag']:
            ...
            if modeling_options["flags"]["blade"]:
                ...
                self.connect("assembly.prebend", "raft.precurve")
                self.connect("assembly.prebendTip", "raft.precurveTip")
                self.connect("assembly.presweep", "raft.presweep")
                self.connect("assembly.presweepTip", "raft.presweepTip")
