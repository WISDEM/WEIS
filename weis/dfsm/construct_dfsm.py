...
class DFSM:
    ...
    def __init__(self,SimulationDetails,L_type = 'LTI',N_type = None,n_samples = 300,sampling_method = 'KM',train_split = 0.8,A_array = None,B_array = None,C_array = None, D_array = None,W = None,interp_type = 'linear'):
        ...
        self.wind_speed_ind = SimulationDetails.wind_speed_ind
        self.gen_torque_ind = SimulationDetails.gen_torque_ind
        self.blade_pitch_ind = SimulationDetails.blade_pitch_ind
        self.wave_elev_ind = SimulationDetails.wave_elev_ind
