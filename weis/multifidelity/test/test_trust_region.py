...
class Test(unittest.TestCase):
    ...
    def test_1d_constrained_optimization(self):
        ...
        np.testing.assert_allclose(results["outputs"]["con"], 2.2, atol=1e-5)
    ...
    def test_1d_constrained_optimization_lower(self):
        ...
        np.testing.assert_allclose(results["outputs"]["con"], 2.4, atol=1e-5)
    ...
    def test_1d_constrained_optimization_upper(self):
        ...
        np.testing.assert_allclose(results["outputs"]["con"], 1.75, atol=1e-5)
