...
class TuneROSCO(ExplicitComponent):
    ...
    def compute(self,inputs,outputs, discrete_inputs, discrete_outputs):
        ...
        WISDEM_turbine.J            = float(inputs['rotor_inertia'][0])        # TODO: ROSCO is actually looking for drivetrain inertia here!  It's been fixed from ROSCO_Turbine below, but maybe not WISDEM
        ...
        WISDEM_turbine.GBoxEff      = float(inputs['gearbox_efficiency'][0]) * 100.
