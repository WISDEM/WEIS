...
class TuneROSCO(ExplicitComponent):
    ...
    def compute(self,inputs,outputs, discrete_inputs, discrete_outputs):
        ...
        # DISCON Parameters
        #   - controller
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']  = {}
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['LoggingLevel'] = controller.LoggingLevel
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_LPFType'] = controller.F_LPFType
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_NotchType'] = controller.F_NotchType
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['IPC_ControlMode'] = controller.IPC_ControlMode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_ControlMode'] = controller.VS_ControlMode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_ControlMode'] = controller.PC_ControlMode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Y_ControlMode'] = controller.Y_ControlMode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SS_Mode'] = controller.SS_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_Mode'] = controller.WE_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PS_Mode'] = controller.PS_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SD_Mode'] = controller.SD_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Fl_Mode'] = controller.Fl_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Flp_Mode'] = controller.Flp_Mode
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_LPFDamping'] = controller.F_LPFDamping
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_SSCornerFreq'] = controller.ss_cornerfreq
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_GS_angles'] = controller.pitch_op_pc
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_GS_KP'] = controller.pc_gain_schedule.Kp
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_GS_KI'] = controller.pc_gain_schedule.Ki
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_MaxPit'] = controller.max_pitch
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_MinPit'] = controller.min_pitch
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['IPC_Ki'] = float(inputs['IPC_Ki1p'])
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_MinOMSpd'] = controller.vs_minspd
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_Rgn2K'] = controller.vs_rgn2K
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_RefSpd'] = controller.vs_refspd
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_KP'] = controller.vs_gain_schedule.Kp
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_KI'] = controller.vs_gain_schedule.Ki
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SS_VSGain'] = controller.ss_vsgain
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SS_PCGain'] = controller.ss_pcgain
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_FOPoles_N'] = len(controller.v)
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_FOPoles_v'] = controller.v
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_FOPoles'] = controller.A
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['ps_wind_speeds'] = controller.v
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PS_BldPitchMin'] = controller.ps_min_bld_pitch
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SD_MaxPit'] = controller.sd_maxpit + 0.1
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['SD_CornerFreq'] = controller.sd_cornerfreq
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Fl_Kp'] = controller.Kp_float
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Flp_Kp'] = controller.Kp_flap
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Flp_Ki'] = controller.Ki_flap
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Flp_MaxPit'] = controller.flp_maxpit
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Flp_Angle'] = 0.
        
        # - turbine
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_BladeRadius'] = WISDEM_turbine.rotor_radius
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['v_rated'] = float(inputs['v_rated'])
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_FlpCornerFreq']  = [float(inputs['flap_freq']) * 2 * np.pi / 3., 0.7]
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_LPFCornerFreq']  = float(inputs['edge_freq']) * 2 * np.pi / 4.
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_NotchCornerFreq'] = WISDEM_turbine.twr_freq    # inputs(['twr_freq']) # zero for now, fix when floating introduced to WISDEM
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['F_FlCornerFreq'] = [WISDEM_turbine.ptfm_freq, 0.707] # inputs(['ptfm_freq']) # zero for now, fix when floating introduced to WISDEM
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_MaxRat'] = WISDEM_turbine.max_pitch_rate
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_MinRat'] = -WISDEM_turbine.max_pitch_rate
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_MaxRat'] = WISDEM_turbine.max_torque_rate
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['PC_RefSpd'] = WISDEM_turbine.rated_rotor_speed * WISDEM_turbine.Ng
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_RtPwr'] = WISDEM_turbine.rated_power
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_RtTq'] = WISDEM_turbine.rated_torque
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_MaxTq'] = WISDEM_turbine.rated_torque * 1.1
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['VS_TSRopt'] = WISDEM_turbine.TSR_operational
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_RhoAir'] = WISDEM_turbine.rho
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_GearboxRatio'] = WISDEM_turbine.Ng
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['WE_Jtot'] = WISDEM_turbine.J
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cp_pitch_initial_rad'] = self.pitch_vector
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cp_TSR_initial'] = self.tsr_vector
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cp_table'] = WISDEM_turbine.Cp_table
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Ct_table'] = WISDEM_turbine.Ct_table
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cq_table'] = WISDEM_turbine.Cq_table
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cp'] = WISDEM_turbine.Cp
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Ct'] = WISDEM_turbine.Ct
        self.modeling_options['DLC_driver']['openfast_file_management']['fst_vt']['DISCON_in']['Cq'] = WISDEM_turbine.Cq
